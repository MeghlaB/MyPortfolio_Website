    ...
    <section id="skills" className="py-16 text-white">
      ...
      <div className="max-w-6xl mx-auto text-center mt-6">
        ...
        <div className="grid grid-cols-1 max-h-full lg:h-[550px] px-3 md:px-2 lg:px-0 sm:grid-cols-2 md:grid-cols-3 gap-12 mt-8">
          {/* HTML */}
          <div className="p-10   lg:p-6 border border-gray-700 rounded-lg shadow-lg hover:shadow-xl hover:scale-105 transition-transform duration-300 relative group overflow-hidden animate-gradient-border">
